...
{
    // An interface implementing IUnikaInterface only transitively is silently dropped from
    // InterfaceGenerator's candidacy. The Core equivalent covers IVInterface.
    ...
    public class MissingExplicitInterfaceAnalyzer : DiagnosticAnalyzer
    {
        public static readonly DiagnosticDescriptor MarkerInterfaceNotExplicitDescriptor =
            new DiagnosticDescriptor("Unika_AN0003", "Marker interface must be listed explicitly",
        ...
        {
            PartialAndInterfaceDetection.AnalyzeTypeForMissingExplicitInterface(context, UnikaAnalyzerMarkers.All, UnikaAnalyzerMarkers.ExcludedModulePath,
